  ...
  showDialog = (immediately) =>
    if counter.countdown is @preferences.usesUntilPrompt or immediately
      if !@preferences.useCustomRateDialog
        ...
        navigator.notification.confirm localeObj.message, promptForRatingWindowButtonClickHandler, localeObj.title, [localeObj.rateButtonLabel,
                                                                                                                    localeObj.laterButtonLabel,
                                                                                                                    localeObj.cancelButtonLabel]
