...
AppRateLocales =
	ar:
		...
		laterButtonLabel: "قيم البرنامج الآن"
		rateButtonLabel: "ذكرني لاحقا"
	bn:
		title: "রেট %@"
		...
		laterButtonLabel: "এখন এটি রেটিং করুন"
		rateButtonLabel: "পরে আমাকে মনে করিয়ে দিন"
	ca:
		title: "Ressenya %@"
	...
	cs:
		...
		laterButtonLabel: "Ohodnotit nyní"
		rateButtonLabel: "Připomenout později"
	da:
		title: "Vurdér %@"
		...
		laterButtonLabel: "Vurdér nu"
		rateButtonLabel: "Påmind mig senere"
	de:
		title: "Bewerte %@"
	...
	el:
		...
		laterButtonLabel: "Αξιολόγησε τώρα"
		rateButtonLabel: "Υπενθύμιση αργότερα"
	en:
		title: "Rate %@"
	...
	fa:
		...
		laterButtonLabel: "آن را دوست ندارم حالا"
		rateButtonLabel: "یادآوری من بعد"
	fr:
		title: "Notez %@"
		...
		laterButtonLabel: "Votez maintenant"
		rateButtonLabel: "Me le rappeler ultérieurement"
	he:
		title: "דרג את %@"
		...
		laterButtonLabel: "דרג עכשיו"
		rateButtonLabel: "הזכר לי מאוחר יותר"
	hi:
		title: "दर %@"
		...
		laterButtonLabel: "अब यह दर"
		rateButtonLabel: "मुझे बाद में याद दिलाएं"
	id:
		title: "Beri Nilai %@"
		...
		laterButtonLabel: "Berikan nilai sekarang!"
		rateButtonLabel: "Ingatkan saya lagi"
	il:
		title: "Vota %@"
	...
	nl:
		...
		laterButtonLabel: "Beoordeel nu"
		rateButtonLabel: "Herinner me er later aan"
	no:
		title: "Vurder %@"
		...
		laterButtonLabel: "Vurder nå"
		rateButtonLabel: "Påminn meg senere"
	pa:
		title: "ਦਰ %@"
		...
		laterButtonLabel: "ਹੁਣ ਇਹ ਦਰ ਨੂੰ"
		rateButtonLabel: "ਮੈਨੂੰ ਬਾਅਦ ਵਿੱਚ ਯਾਦ"
	pl:
		title: "Oceń %@"
		...
		laterButtonLabel: "Oceń teraz"
		rateButtonLabel: "Przypomnij później"
	pt:
		title: "Avaliar %@"
		...
		laterButtonLabel: "Avaliar Agora"
		rateButtonLabel: "Lembrar mais tarde"
	ru:
		title: "Оцените %@"
	...
	sk:
		...
		laterButtonLabel: "Ohodnotiť teraz"
		rateButtonLabel: "Pripomenúť neskôr"
	sl:
		title: "Oceni %@"
		...
		laterButtonLabel: "Oceni zdaj"
		rateButtonLabel: "Spomni me kasneje"
	sv:
		title: "Betygsätt %@"
		...
		laterButtonLabel: "Betygsätt nu!"
		rateButtonLabel: "Påminn mig senare"
	th:
		title: "อัตรา %@"
		...
		laterButtonLabel: "ให้คะแนนตอนนี้"
		rateButtonLabel: "กรุณาเตือนผมมา"
	tr:
		title: "Oy %@"
		...
		laterButtonLabel: "Şimdi Oyla"
		rateButtonLabel: "Sonra Hatırlat"
	uk:
		title: "Оцінити %@"
		...
		laterButtonLabel: "Оцінити зараз"
		rateButtonLabel: "Нагадати пізніше"
	ur:
		title: "شرح %@"
		...
		laterButtonLabel: "شرح اب یہ"
		rateButtonLabel: "مجھے بعد میں یاد دلائیں"
	vi:
		title: "Đánh giá %@"
		...
		laterButtonLabel: "Đánh Giá Ngay"
		rateButtonLabel: "Nhắc Tôi Sau"
	'zh-TW':
		title: "評分 %@"
		message: "如果你喜歡使用 %@, 是否介意耽誤您一點時間來給我們一個評分呢？ 該動作不會超過一分鐘。 謝謝您的支持！"
		cancelButtonLabel: "不，謝謝"
		laterButtonLabel: "現在評分"
		rateButtonLabel: "稍後通知我"
